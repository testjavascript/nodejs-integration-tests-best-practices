// ❌ Anti-Pattern file: This exemplifies a too verbose test structure that is flat and shows no categorization to ease the visitor understanding
...
test('When no onSale parameter specified, then exception is thrown', (done) => {
  setTimeout(() => {
    expect({ approved: true }).toMatchObject({ approved: false });
    done();
  }, 15000);
}, 16000);
