...
Ideas: The withdraw money example, simply run the same message multiple times and ensure that the state is similar
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTk3NTM1NDA1MywtMTE3NDcxNjAzMiw0Mj
