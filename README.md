...
:white_check_mark:  **Do:** Various tools and network interceptors (e.g. nock) can tell about the existence and nature of outgoing http requests. Run one of those tools as you plan the test cases to realize which end-points and scenarios should get covered. 
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjA3NDIzMzY0MSw5NTI0MjkzOTEsLTkzMj
